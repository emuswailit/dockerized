...
const BodySystems = (props) => {
  ...
  //Create new instruction state
  const [selectedBodySystem, setSelectedBodySystem] = useState({})
  const [editingBodySystem, setEditingBodySystem] = useState(false)
  const [creatingBodySystem, setCreatingBodySystem] = useState(false)
  ...
  useEffect(() => {
    ...
    setEditingBodySystem(false)
    setCreatingBodySystem(false)
  }, [props.update])
  ...
  const handleDeleteUser = (user_id) => {
    console.log(user_id)
    props.deleteBodySystem(user_id)
  }
    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <TableContainer>
          ...
          <Fragment>
            <Dialog
              open={creatingBodySystem}
              onClose={handleClose}
              aria-labelledby="form-dialog-title"
            >
              {!props.submissionSuccessful && creatingBodySystem && (
                <Fragment>
                  <DialogTitle id="form-dialog-title">
                    Create new body system
                  </DialogTitle>

                  <DialogContent>
                    <DialogContentText>
                      Enter body system details
                    </DialogContentText>
                    <Formik
                      initialValues={{
                        title: "",
              ...
              {editingBodySystem && (
                <React.Fragment>
                  ...
                  <DialogContent>
                    ...
                    <Formik
                      initialValues={{
                        id: selectedBodySystem.id,
                        title: selectedBodySystem.title,
                        description: selectedBodySystem.description,
                      }}
                      onSubmit={(values, {setSubmitting}) => {
                        setOpenErrorSnackBar(true)

                        console.log("at submit", values)
                        props.changeBodySystem(values, selectedBodySystem.id)
                      }}
                      validationSchema={Yup.object().shape({
                        title: Yup.string().required("Title is required"),
                        description: Yup.string().required(
