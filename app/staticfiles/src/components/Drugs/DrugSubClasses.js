    ...
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <TableContainer>
          ...
          <Fragment className={classes.formFormik}>
            {/* 1. Create drug class dialog */}
            <Dialog
              className={classes.modal}
              open={creatingDrugClass}
              onClose={handleClose}
              ...
              {creatingDrugClass && (
                <React.Fragment>
                  <DialogTitle id="form-dialog-title">
                    Create new drug sub class
                  </DialogTitle>
                  <DialogContent>
                    <DialogContentText>
                      Enter drug sub class details
                    </DialogContentText>
                    <Formik
                      initialValues={{
                        title: "",
                      ...
                      validationSchema={Yup.object().shape({
                        ...
                        drug_class: Yup.string().required("Select body sytem"),
                      })}
                    >
                      {(props) => {
                        const {
                          ...
                          <form onSubmit={handleSubmit}>
                            <div>
                              ...
                              <Autocomplete
                                ...
                                options={drugClasses}
                                onChange={(e, value) =>
                                  handleAutoCompleteValues(setFieldValue, value)
                                }
            ...
            >
              {editDrugClass && (
                <React.Fragment>
                  ...
                  <DialogContent>
                    <DialogContentText>Enter detail changes</DialogContentText>
                    <Formik
                      initialValues={{
                        title: selectedDrugClass.title,
